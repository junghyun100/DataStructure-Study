public class DoublyLinkedList {
    ...
    public static void main(String[] args) { 
        ...
        list.addLast(50); System.out.println(list.toString()); // 10 20 25 30 40 50 
        list.removeFirst(); System.out.println(list.toString()); // 20 25 30 40 50 
        list.removeLast(); System.out.println(list.toString()); // 20 25 30 40 
        list.remove(1); System.out.println(list.toString()); // 20 30 40 
    } 
}